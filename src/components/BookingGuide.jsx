    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-full lg:flex-row">
        <Guide
          icon={
            <svg
              className="w-14 h-14 fill-color-primary z-40 "
          ...
          header="Select a car"
          body=" We offer a big range of vehicles for all yout driving needs. We have the
      ...
      "
        ...
        <Guide
          icon={
            ...
            >
              <g transform="translate(0 1)">
                <g>
                  <path
                    d="M486.4,423.96c-50.93-27.008-89.996-42.152-124.772-47.958l3.599-4.948c1.707-1.707,2.56-4.267,1.707-6.827l-7.997-31.987
          ...
          body="Our friendly and knowledgable operators are always ready to help with any questions or concerns
      "
        />
        <Guide
          icon={
          ...
          header="Let's drive"
          body="Whether you are hitting the open road we've got you covered with wide range of cars "
        />
      </div>
    </div>
  );
