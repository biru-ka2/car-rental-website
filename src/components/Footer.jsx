  ...
  return (
    ...
    >
      ...
      <div className="">
        ...
        <p className="mb-2">Addis Ababa</p>
      ...
      <div className="col-span-3 px-2 lg:col-span-1">
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          <p>bworku1221@gmail.com</p>
        </div>
        <div className="flex mt-3 items-center justify-center gap-3">
          <a href="https://github.com/biru-ka2" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://www.linkedin.com/in/biru-ka2/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-color-primary w-8 h-8 hover:fill-color-primary-l duration-200 hover:scale-90"
              viewBox="0 0 256 256"
          ...
          <a href="https://instagram.com/biru-ka2" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-color-primary w-8 h-8 hover:fill-color-primary-l duration-200 hover:scale-90"
              viewBox="0 0 256 256"
